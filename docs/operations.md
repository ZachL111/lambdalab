...
`lambdalab` is centered on interpreters work in Haskell. The technical target is: Reduce lambda-calculus terms with alpha-safe normal order.
...
The score is deterministic. The current threshold is 173. Risk has a penalty of 4, latency has a penalty of 4, and weight contributes a bonus of 4.
