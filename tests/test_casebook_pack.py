"""Regression checks for the lambdalab casebook."""
...
from casebook.harness import assert_expected, lambdalab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lambdalab_summary(), assert_expected())
