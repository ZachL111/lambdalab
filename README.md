...
lambdalab is a Haskell project for interpreters. It focuses on this technical goal: Reduce lambda-calculus terms with alpha-safe normal order.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 173, risk penalty 4, latency penalty 4, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
